...
const CTA = () => (
  <div className="apex__cta">
    <div className="apex__cta-content">
      <h3>DRAG OVER A TURN TO EXAMINE.</h3>
      <p className='apex__cta-content_main'>GPS Modeled Track analysis for 25+ famous racetracks!</p>
      
      <img src={physics} alt="Track model "></img>


      <p className='apex__cta-content_citation_1'>Above image adapted from :
      Lovato, S., Massaro, M. & Limebeer, D.J.N. Curved-ribbon-based track modelling for minimum lap-time optimisation. 
      </p>

      <p className='apex__cta-content_main'>How it works:</p>
